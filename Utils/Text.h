...
enum
{
	...
	MSG_MERC_CASTS_LIGHT_ON,				// 108
	MSG_MERC_CASTS_LIGHT_OFF,				// 109

	MSG_SQUAD_ACTIVE_STRING,				// 110
	MSG_MERC_TOOK_CIGARETTE,				// 111

	MSG_PROMPT_CHEATS_ACTIVATE,				// 112
	MSG_PROMPT_CHEATS_DEACTIVATE,			// 113
