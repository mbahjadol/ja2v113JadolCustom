...
BOOLEAN EnterBobbyR()
{
	...
	UINT16	usMouseRegionPosArray[] = {
		static_cast<UINT16>(BOBBIES_USED_SIGN_X),
		static_cast<UINT16>(BOBBIES_USED_SIGN_Y),
		static_cast<UINT16>(BOBBIES_USED_SIGN_X + BOBBIES_USED_SIGN_WIDTH),
		static_cast<UINT16>(BOBBIES_USED_SIGN_Y + BOBBIES_USED_SIGN_HEIGHT),
		static_cast<UINT16>(BOBBIES_MISC_SIGN_X),
		static_cast<UINT16>(BOBBIES_MISC_SIGN_Y),
		static_cast<UINT16>(BOBBIES_MISC_SIGN_X + BOBBIES_MISC_SIGN_WIDTH),
		static_cast<UINT16>(BOBBIES_MISC_SIGN_Y + BOBBIES_MISC_SIGN_HEIGHT),
		static_cast<UINT16>(BOBBIES_GUNS_SIGN_X),
		static_cast<UINT16>(BOBBIES_GUNS_SIGN_Y),
		static_cast<UINT16>(BOBBIES_GUNS_SIGN_X + BOBBIES_GUNS_SIGN_WIDTH),
		static_cast<UINT16>(BOBBIES_GUNS_SIGN_Y + BOBBIES_GUNS_SIGN_HEIGHT),
		static_cast<UINT16>(BOBBIES_AMMO_SIGN_X),
		static_cast<UINT16>(BOBBIES_AMMO_SIGN_Y),
		static_cast<UINT16>(BOBBIES_AMMO_SIGN_X + BOBBIES_AMMO_SIGN_WIDTH),
		static_cast<UINT16>(BOBBIES_AMMO_SIGN_Y + BOBBIES_AMMO_SIGN_HEIGHT),
		static_cast<UINT16>(BOBBIES_ARMOUR_SIGN_X),
		static_cast<UINT16>(BOBBIES_ARMOUR_SIGN_Y),
		static_cast<UINT16>(BOBBIES_ARMOUR_SIGN_X + BOBBIES_ARMOUR_SIGN_WIDTH),
		static_cast<UINT16>(BOBBIES_ARMOUR_SIGN_Y + BOBBIES_ARMOUR_SIGN_HEIGHT)
	};
