...
// JADOL -- Move this enum from EditorMercs.h to this !
//-----------------------------------------------
//
// civilian "sub teams":
enum
{
	...
	UNNAMED_CIV_GROUP_16,	UNNAMED_CIV_GROUP_17,
...
// JADOL -- set enum for Battle Sound Type

// 0 ~ 1
enum NonProfileBattleSound_Kids {
	NPBS_KIDS_TYPE0 = 0,
	NPBS_KIDS_TYPE1,
	NPBS_KIDS_MAXTYPE
};
...
// 0 ~ 5
enum NonProfileBattleSound_Male {
	NPBS_MALE_TYPE0 = 0,
	NPBS_MALE_TYPE1,
	NPBS_MALE_TYPE2,
	NPBS_MALE_TYPE3,
...
// 6 ~ 8
enum NonProfileBattleSound_Female {
	NPBS_FEMALE_TYPE6 = 6,
	NPBS_FEMALE_TYPE7,
	NPBS_FEMALE_TYPE8,
	NPBS_FEMALE_MAXTYPE
